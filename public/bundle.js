...
// (34:3) {#each $category as post, x}
function create_each_block$6(component, ctx) {
	var tr, td, text_value = ctx.post.author, text, text_1, p, text_2, text_3, text_4, span, a, text_5_value = ctx.post.title, text_5, a_href_value, span_1, span_2, text_6, text_8, p_1, span_3, text_9, span_4, text_10, span_5, text_11, text_13, p_2, raw_value = ctx.post.post, text_16, td_1, text_17_value = ctx.post.date, text_17, span_6, text_18_value = ctx.post.mins ? ctx.post.mins : '', text_18, span_7;
	...
	return {
		c: function create() {
			...
			p = createElement("p");
			text_2 = createText("/");
			text_3 = createText(ctx.$id);
			text_4 = createText("/    article: ");
			span = createElement("span");
			a = createElement("a");
			text_5 = createText(text_5_value);
			span_1 = createElement("span");
			span_2 = createElement("span");
			text_6 = createText("↑ top");
			text_8 = createText("\r\n\t\t\t ");
			p_1 = createElement("p");
			span_3 = createElement("span");
			text_9 = createText("pro");
			span_4 = createElement("span");
			text_10 = createText("con");
			span_5 = createElement("span");
			text_11 = createText("add note");
			text_13 = createText("\r\n\t\t\t ");
			p_2 = createElement("p");
			text_16 = createText("\r\n\t\t   ");
			td_1 = createElement("td");
			...
			a.href = a_href_value = "" + ctx.post.url + (ctx.post.id ? `#${ctx.post.id}` : '');
			a.target = "_blank";
			addLoc(a, file$11, 38, 50, 1115);

			span_2._svelte = { component };

			addListener(span_2, "click", click_handler$3);
			span_2.className = "pull-right";
			addLoc(span_2, file$11, 38, 139, 1204);
			addLoc(span_1, file$11, 38, 133, 1198);
			addLoc(span, file$11, 38, 44, 1109);
			p.className = "postInfo";
			addLoc(p, file$11, 38, 4, 1069);

			span_3._svelte = { component, ctx };

			addListener(span_3, "click", click_handler_1$2);
			span_3.className = "tb_pro";
			addLoc(span_3, file$11, 41, 5, 1313);

			span_4._svelte = { component, ctx };

			addListener(span_4, "click", click_handler_2$2);
			span_4.className = "tb_con";
			addLoc(span_4, file$11, 41, 88, 1396);

			span_5._svelte = { component, ctx };

			addListener(span_5, "click", click_handler_3$2);
			span_5.className = "tb_note";
			addLoc(span_5, file$11, 41, 171, 1479);
			p_1.className = "toolbar";
			addLoc(p_1, file$11, 40, 4, 1287);
			p_2.className = "posting svelte-peuc5d";
			addLoc(p_2, file$11, 43, 4, 1585);
			td.className = " svelte-peuc5d";
			addLoc(td, file$11, 36, 5, 988);
			addLoc(span_7, file$11, 47, 83, 1733);
			span_6.className = "right10";
			addLoc(span_6, file$11, 47, 33, 1683);
			td_1.className = "date svelte-peuc5d";
			addLoc(td_1, file$11, 47, 5, 1655);
			addLoc(tr, file$11, 34, 3, 971);
		},
		...
		m: function mount(target, anchor) {
			...
			appendNode(text_8, td);
			appendNode(p_1, td);
			appendNode(span_3, p_1);
			appendNode(text_9, span_3);
			appendNode(span_4, p_1);
			appendNode(text_10, span_4);
			appendNode(span_5, p_1);
			appendNode(text_11, span_5);
			...
			appendNode(span_6, td_1);
			appendNode(text_18, span_6);
			appendNode(span_7, span_6);
		},

		p: function update(changed, ctx) {
			if ((changed.$category) && text_value !== (text_value = ctx.post.author)) {
				text.data = text_value;
			}
			...
			if ((changed.$category) && text_5_value !== (text_5_value = ctx.post.title)) {
				text_5.data = text_5_value;
			}
			...
			if ((changed.$category) && text_17_value !== (text_17_value = ctx.post.date)) {
				text_17.data = text_17_value;
			}

			if ((changed.$category) && text_18_value !== (text_18_value = ctx.post.mins ? ctx.post.mins : '')) {
		...
		d: function destroy$$1(detach) {
			...
			link.destroy();
			removeListener(span_2, "click", click_handler$3);
...
function create_if_block$6(component, ctx) {
	var p, text_value = ctx.$category.length, text, text_1, text_2, div, input, span, text_3, text_4, span_1, text_6, table, thead, tr, th, text_7, text_8, th_1, text_9, text_12, tbody, table_transition, current;
	...
	return {
		c: function create() {
			...
			tr = createElement("tr");
			th = createElement("th");
			text_7 = createText("post");
			text_8 = createText("\r\n\t\t\t ");
			th_1 = createElement("th");
			text_9 = createText("date");
			text_12 = createText("\r\n\t\t \r\n\t\t ");
			tbody = createElement("tbody");
			...
			addLoc(th, file$11, 21, 4, 741);
			setAttribute(th_1, "width", "250");
			addLoc(th_1, file$11, 22, 4, 761);
			addLoc(tr, file$11, 19, 5, 726);
			addLoc(thead, file$11, 18, 3, 712);
			tbody.id = "posts";
			addLoc(tbody, file$11, 31, 3, 912);
			table.id = "posts";
			table.className = "pure-table";
			addLoc(table, file$11, 17, 1, 652);
		},
		...
		p: function update(changed, ctx) {
			...
			if (changed.$category || changed.$id || changed.$author) {
...
function Category_details(options) {
	...
	this._state = assign(this.store._init(["id","category","author"]), options.data);
	this.store._add(this, ["id","category","author"]);
	this._recompute({ $id: 1 }, this._state);
	...
	if (!('$author' in this._state)) console.warn("<Category_details> was created without expected data property '$author'");
	this._intro = true;
