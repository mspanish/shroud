...
const file$4 = "src\\pages\\categories\\categories.html";

function create_main_fragment$4(component, ctx) {
	var div, h1, text, text_1, table, thead, tr, th, text_2, text_3, th_1, text_4, text_7, tbody;

	var if_block = (ctx.$categories && ctx.$categories.length > 0) && create_if_block$1(component, ctx);
	...
	return {
		c: function create() {
			...
			if (if_block) if_block.c();
			h1.className = "auth svelte-124qc1x";
			addLoc(h1, file$4, 1, 0, 38);
			addLoc(th, file$4, 6, 2, 141);
			addLoc(th_1, file$4, 7, 2, 158);
			addLoc(tr, file$4, 5, 3, 133);
			addLoc(thead, file$4, 4, 1, 121);
			addLoc(tbody, file$4, 16, 1, 291);
			table.className = "pure-table";
			addLoc(table, file$4, 3, 0, 92);
			div.className = "content is-medium home svelte-124qc1x";
...
function create_each_block$2(component, ctx) {
	...
	return {
		c: function create() {
			...
			td.className = "svelte-124qc1x";
			addLoc(td, file$4, 20, 6, 397);
			td_1.className = "svelte-124qc1x";
			addLoc(td_1, file$4, 28, 6, 666);
			addLoc(tr, file$4, 19, 4, 385);
		},
...
function create_each_block_1(component, ctx) {
	...
	var link_initial_data = { href: "/categories/" + ctx.subdir[0] };
	var link = new Link({
		root: component.root,
		store: component.store,
		slots: { default: createFragment() },
	...
	return {
		...
		p: function update(changed, ctx) {
			...
			var link_changes = {};
			if (changed.$categories) link_changes.href = "/categories/" + ctx.subdir[0];
			link._set(link_changes);
		},
...
assign(Categories.prototype, methods$4);
...
const file$5 = "src\\components\\Input.html";
...
function create_main_fragment$5(component, ctx) {
	...
	return {
		c: function create() {
			...
			addLoc(input, file$5, 2, 2, 29);
			addListener(button, "click", click_handler);
			button.id = "input_btn";
			button.className = "pure-button";
			addLoc(button, file$5, 4, 4, 177);
...
const file$6 = "src\\components\\TextInput.html";
...
function create_main_fragment$6(component, ctx) {
	...
	return {
		c: function create() {
			...
			textarea.value = "\r\n    ";
			addLoc(textarea, file$6, 2, 1, 29);
			addListener(button, "click", click_handler);
			button.id = "input_btn";
			button.className = "pure-button";
			addLoc(button, file$6, 5, 4, 207);
			form.className = "pure-form";
			addLoc(form, file$6, 0, 0, 0);
		},
...
const file$7 = "src\\components\\Buttons.html";
...
function create_main_fragment$7(component, ctx) {
	...
	var if_block = (ctx.btn2) && create_if_block$2(component, ctx);
	...
	return {
		c: function create() {
			...
			addLoc(button, file$7, 15, 4, 326);
			div.className = "pure-g buttonHolder svelte-p06i2w";
			addLoc(div, file$7, 14, 0, 287);
		},
...
assign(Buttons.prototype, methods$5);
...
function create_main_fragment$11(component, ctx) {
	var div, h1, text, text_1, span, text_2, text_3, span_1, text_4, div_transition, current;
	...
	return {
		c: function create() {
			...
			text_1 = createText("\r\n\r\n ");
			span = createElement("span");
			text_2 = createText("go to notebook");
			link._fragment.c();
			text_3 = createText("\r\n\r\n ");
			span_1 = createElement("span");
			text_4 = createText("all authors");
			link_1._fragment.c();
			h1.className = "svelte-peuc5d";
			addLoc(h1, file$11, 2, 0, 65);
			span.className = "follow btn-nav tb_buttons tb_note";
			addLoc(span, file$11, 4, 1, 89);
			span_1.className = "follow btn-nav tb_buttons tb_note";
			addLoc(span_1, file$11, 6, 1, 195);
			div.id = "postWrap";
			div.className = "content is-medium svelte-peuc5d";
		...
		m: function mount(target, anchor) {
			...
			appendNode(text_1, div);
			appendNode(span, div);
			appendNode(text_2, link._slotted.default);
			link._mount(span, null);
			appendNode(text_3, div);
			appendNode(span_1, div);
			appendNode(text_4, link_1._slotted.default);
...
function Category_details(options) {
	...
	this._state = assign(this.store._init(["id"]), options.data);
...
Category_details.prototype._checkReadOnly = function _checkReadOnly(newState) {
	if ('author_name' in newState && !this._updatingReadonlyProperty) throw new Error("<Category_details>: Cannot set read-only property 'author_name'");
};

Category_details.prototype._recompute = function _recompute(changed, state) {
	if (changed.$id) {
		if (this._differs(state.author_name, (state.author_name = author_name$1(state)))) changed.author_name = true;
	}
};
