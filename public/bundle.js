...
function create_main_fragment$4(component, ctx) {
	var div, text, text_1, table, thead, tr, th, text_2, text_3, th_1, text_4, text_7, tbody, div_transition, current;
...
function create_each_block$2(component, ctx) {
	...
	return {
		c: function create() {
			...
			td_1 = createElement("td");
			text_2 = createText(text_2_value);
			addLoc(td, file$4, 20, 4, 386);
			addLoc(td_1, file$4, 21, 4, 411);
			addLoc(tr, file$4, 19, 2, 376);
		},
