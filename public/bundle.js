...
function create_each_block$2(component, ctx) {
	...
	return {
		...
		m: function mount(target, anchor) {
			...
			appendNode(text_9, tr);
			appendNode(td_3, tr);
			appendNode(text_10, link._slotted.default);
		...
		p: function update(changed, ctx) {
			...
			if ((changed.$bookmarks) && text_7_value !== (text_7_value = ctx.bookmark[1].post)) {
				text_7.data = text_7_value;
			}

			if ((changed.$bookmarks) && text_10_value !== (text_10_value = ctx.bookmark[1].author)) {
			...
			if ((changed.$bookmarks) && text_12_value !== (text_12_value = ctx.bookmark[1].date)) {
