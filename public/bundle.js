...
function create_main_fragment$4(component, ctx) {
	...
	return {
		c: function create() {
			...
			addLoc(h1, file$4, 1, 1, 64);
			addLoc(th, file$4, 6, 3, 143);
			addLoc(th_1, file$4, 7, 3, 165);
			addLoc(tr, file$4, 5, 4, 134);
			addLoc(thead, file$4, 4, 2, 121);
			tbody.id = "categories";
			addLoc(tbody, file$4, 16, 2, 305);
			table.className = "pure-table";
			addLoc(table, file$4, 3, 1, 91);
			div.id = "postWrap";
